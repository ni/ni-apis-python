...
def bintime_datetime_to_protobuf_message(python_value: bt.DateTime) -> PrecisionTimestamp:
...
def precision_timestamp_to_python_value(protobuf_message: PrecisionTimestamp) -> bt.DateTime:

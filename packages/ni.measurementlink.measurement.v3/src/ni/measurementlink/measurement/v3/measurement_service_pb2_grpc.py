...
from ni.measurementlink.measurement.v3 import measurement_service_pb2 as ni_dot_measurementlink_dot_measurement_dot_v3_dot_measurement__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in ni/measurementlink/measurement/v3/measurement_service_pb2_grpc.py depends on'
...
def add_MeasurementServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ni.measurementlink.measurement.v3.MeasurementService', rpc_method_handlers)

...
def test___discovery_service_not_running___get_discovery_service_address___starts_discovery_service(
    ...
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._support._get_key_file_path",
        return_value=temp_discovery_key_file_path,
    )
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._support._service_already_running",
        return_value=False,
    )
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._support._get_registration_json_file_path",
...
def test___key_file_never_created___get_discovery_service_address___throws_timeout_error(
    ...
    mocker.patch("ni.measurementlink.discovery.v1.client._support._START_SERVICE_TIMEOUT", 5.0)
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._support._open_key_file", side_effect=OSError
    )
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._support._get_registration_json_file_path",
        return_value=temp_registration_json_file_path,
...
def test___key_file_exist_after_poll___start_discovery_service___discovery_service_started(
    ...
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._support._open_key_file",
...
def discovery_client(
    ...
    mocker.patch(
        "ni.measurementlink.discovery.v1.client._client.DiscoveryClient._get_stub",

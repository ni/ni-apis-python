...
class Operator(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["extensions", b"extensions", "id", b"id", "link", b"link", "operator_name", b"operator_name", "role", b"role", "schema_id", b"schema_id"]) -> None: ...
...
class TestDescription(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["extensions", b"extensions", "id", b"id", "link", b"link", "schema_id", b"schema_id", "test_description_name", b"test_description_name", "uut_id", b"uut_id"]) -> None: ...
...
class Test(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "extensions", b"extensions", "id", b"id", "link", b"link", "schema_id", b"schema_id", "test_name", b"test_name"]) -> None: ...
...
class TestStation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["asset_identifier", b"asset_identifier", "extensions", b"extensions", "id", b"id", "link", b"link", "schema_id", b"schema_id", "test_station_name", b"test_station_name"]) -> None: ...

...
class DataStoreService(object):
    ...
    def EvaluateDataQuery(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ni.measurements.data.v1.DataStoreService/EvaluateDataQuery',
    ...
    def ProvideEvaluationFeedback(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ni.measurements.data.v1.DataStoreService/ProvideEvaluationFeedback',
    ...
    def EnumerateData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ni.measurements.data.v1.DataStoreService/EnumerateData',

...
@typing.final
class EvaluateDataQueryRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        query: ni.measurements.data.v1.data_store_pb2.UnevaluatedQuery | None = ...,
    ) -> None: ...
...
global___EvaluateDataQueryRequest = EvaluateDataQueryRequest

@typing.final
class EvaluateDataQueryResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def __init__(
        self,
        *,
        evaluated_queries: collections.abc.Iterable[ni.measurements.data.v1.data_store_pb2.EvaluatedQuery] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["evaluated_queries", b"evaluated_queries"]) -> None: ...

global___EvaluateDataQueryResponse = EvaluateDataQueryResponse

@typing.final
class ProvideEvaluationFeedbackRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing.Literal["query", b"query", "sql", b"sql", "valid", b"valid"]) -> None: ...

global___ProvideEvaluationFeedbackRequest = ProvideEvaluationFeedbackRequest

@typing.final
class ProvideEvaluationFeedbackResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ProvideEvaluationFeedbackResponse = ProvideEvaluationFeedbackResponse

@typing.final
class EnumerateDataRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    UNEVALUATED_QUERY_FIELD_NUMBER: builtins.int
    EVALUATED_QUERY_LIST_FIELD_NUMBER: builtins.int
    ...
    def __init__(
        self,
        *,
        unevaluated_query: ni.measurements.data.v1.data_store_pb2.UnevaluatedQuery | None = ...,
        evaluated_query_list: ni.measurements.data.v1.data_store_pb2.EvaluatedQueryList | None = ...,
        page_size: builtins.int = ...,
        page_token: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["evaluated_query_list", b"evaluated_query_list", "query", b"query", "unevaluated_query", b"unevaluated_query"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["evaluated_query_list", b"evaluated_query_list", "page_size", b"page_size", "page_token", b"page_token", "query", b"query", "unevaluated_query", b"unevaluated_query"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["query", b"query"]) -> typing.Literal["unevaluated_query", "evaluated_query_list"] | None: ...

global___EnumerateDataRequest = EnumerateDataRequest

@typing.final
class EnumerateDataResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing.Literal["has_next_page", b"has_next_page", "next_page_token", b"next_page_token", "stored_data_values", b"stored_data_values"]) -> None: ...

global___EnumerateDataResponse = EnumerateDataResponse
...
class PublishConditionSetRequest(google.protobuf.message.Message):
    ...
    PUBLISH_LOCATION_FIELD_NUMBER: builtins.int
    MEASUREMENT_METADATA_FIELD_NUMBER: builtins.int
    MEASUREMENT_ID_FIELD_NUMBER: builtins.int
    publish_location: ni.measurements.data.v1.data_store_pb2.PublishDataLocation.ValueType
    ...
    def ClearField(self, field_name: typing.Literal["condition_set", b"condition_set", "measurement", b"measurement", "measurement_id", b"measurement_id", "measurement_metadata", b"measurement_metadata", "publish_location", b"publish_location"]) -> None: ...
...
class PublishDataRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "error_message", b"error_message", "error_state", b"error_state", "hardware", b"hardware", "hardware_identifier_list", b"hardware_identifier_list", "hardware_list", b"hardware_list", "measurement", b"measurement", "measurement_id", b"measurement_id", "measurement_metadata", b"measurement_metadata", "notes", b"notes", "pass_fail_status", b"pass_fail_status", "publish_location", b"publish_location", "software", b"software", "software_identifier_list", b"software_identifier_list", "software_list", b"software_list", "timestamp", b"timestamp"]) -> None: ...
    @typing.overload
...
class PublishDataBatchRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "error_message", b"error_message", "error_state", b"error_state", "hardware", b"hardware", "hardware_identifier_list", b"hardware_identifier_list", "hardware_list", b"hardware_list", "measurement", b"measurement", "measurement_id", b"measurement_id", "measurement_metadata", b"measurement_metadata", "pass_fail_status", b"pass_fail_status", "publish_location", b"publish_location", "software", b"software", "software_identifier_list", b"software_identifier_list", "software_list", b"software_list", "timestamp", b"timestamp"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["hardware", b"hardware"]) -> typing.Literal["hardware_list", "hardware_identifier_list"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["measurement", b"measurement"]) -> typing.Literal["measurement_metadata", "measurement_id"] | None: ...
